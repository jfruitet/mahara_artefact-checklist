...
class ArtefactTypeChecklist extends ArtefactType {
	...
	public static function get_icon_edit($options=null) {
        global $THEME;
        return $THEME->get_url('images/btn_edit.png', false, 'artefact/checklist');
	}

	public static function get_icon_add($options=null) {
        global $THEME;
        return $THEME->get_url('images/btn_add.png', false, 'artefact/checklist');
	}

	public static function get_icon_movedown($options=null) {
        global $THEME;
        return $THEME->get_url('images/btn_movedown.png', false, 'artefact/checklist');
	}

	public static function get_icon_moveup($options=null) {
        global $THEME;
        return $THEME->get_url('images/btn_moveup.png', false, 'artefact/checklist');
	}

	public static function get_icon_delete($options=null) {
        global $THEME;
        return $THEME->get_url('images/btn_deleteremove.png', false, 'artefact/checklist');
	}

	public static function get_icon_configure($options=null) {
        global $THEME;
        return $THEME->get_url('images/btn_configure.png', false, 'artefact/checklist');
	}

	public static function get_icon_export($options=null) {
        global $THEME;
        return $THEME->get_url('images/btn_export.png', false, 'artefact/checklist');
	}
    ...
    */
    ...
    public static function build_checklists_list_html(&$checklists) {
        ...
        $smarty->assign('iconexport', ArtefactTypeChecklist::get_icon_export());
					...
					if (preg_match("/,/", $item->scale)){
	    	        	...
	    	        	if ($tabscale = explode(',', $item->scale)){
				            ...
				            $elements['scale'.$i] = array(
								...
								'options' => $options,
                                // 'rowsize' => $max-1, // Non pris en commpte dans la version 15.10 de Mahara
							);
