...
class PluginBlocktypeChecklist extends PluginBlocktype {
    ...
    public static function instance_config_form($instance) {
        ...
        $elements = array();
        $elements['artefactid'] = self::artefactchooser_element((isset($configdata['artefactid'])) ? $configdata['artefactid'] : null);
        $elements['message'] = array(
            'type' => 'html',
            'value' => get_string('filloutyourchecklist', 'blocktype.checklist/checklist', '<a href="' . get_config('wwwroot') . 'artefact/checklist/">', '</a>'),
        );
