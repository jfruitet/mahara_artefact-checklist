...
define('TITLE', get_string('scalevalidation','artefact.checklist'));
...
$editform = ArtefactTypeChecklist::get_form_valuesindex($artefact, $items);

$smarty = smarty();
$smarty->assign('editform', $editform);
$smarty->assign('PAGEHEADING', hsc(get_string("scalevalidation", "artefact.checklist")));
$smarty->assign('SUBPAGENAV', PluginArtefactChecklist::submenu_items());
$smarty->display('artefact:checklist:valide_index.tpl');
