    ...
    <div class="{cycle values='r0,r1'} listrow">
            ...
            <div class="fr checkliststatus">
                ...
                <a href="{$WWWROOT}artefact/checklist/edit/index.php?id={$checklist->id}" title="{str tag=edit}" >
                    <img src="{theme_url filename='images/btn_edit.png'}" alt="{str(tag=editspecific arg1=$checklist->title)|escape:html|safe}"></a>
                <a href="{$WWWROOT}artefact/checklist/checklist.php?id={$checklist->id}" title="{str tag=manageitems section=artefact.checklist}">
                    <img src="{theme_url filename='images/btn_configure.png'}" alt="{str(tag=manageitemsspecific section=artefact.checklist arg1=$checklist->title)|escape:html|safe}"></a>
                <a href="{$WWWROOT}artefact/checklist/export/index.php?id={$checklist->id}" title="{str tag=export section=artefact.checklist}" >
                    <img src="{theme_url filename='images/btn_export.png'}" alt="{str(tag=exportspecific  section=artefact.checklist arg1=$checklist->title)|escape:html|safe}"></a>			
				<a href="{$WWWROOT}artefact/checklist/delete/index.php?id={$checklist->id}" title="{str tag=delete}">
                    <img src="{theme_url filename='images/btn_deleteremove.png'}" alt="{str(tag=deletespecific arg1=$checklist->title)|escape:html|safe}"></a>
