...
est un décalque (avec des fonctions moins ambitieuses) des plugins CheckList / CheckSkill de Moodle dans leur usage 
...
En général, comme on est plutôt dans le contexte de l'évaluation des compétences, les items sot des compétences et le barème de type LOMER :
...
Bine sûr on peut détourner Checklist pour implanter une  liste de course  :
